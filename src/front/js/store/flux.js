		...
		actions: {
			...
			login: async (email, password) => {
				...
				try {
					...
					const response = await fetch('https://3001-faldea1-p31finalproject-jn8jefi4o4z.ws-us84.gitpod.io/api/token', options)
			...
			getMessage: async () => {
				try{
					...
					const resp = await fetch('https://3001-faldea1-p31finalproject-jn8jefi4o4z.ws-us84.gitpod.io/api/hello', options)
